...
void checkNewton()
{
    COEFFICIENTS c = { 0.00038443501223284215, 6.772363815432673, 1.538534714051183 };
    INEQUALITY_CONSTRAINT_ARRAY A = {
        { 4.050982090949739, 0.7780072638241214, 3.5670863532196555 },
        { 1, 0, 0 },
        { 0, 1, 0 },
        { 0, 0, 1 }
    };
    INEQUALITY_CONSTRAINT_VECTOR b = { 0.9688321535121557, 0, 0, 0 };
